(() => {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".anime-pictures__slider")) new core(".anime-pictures__slider", {
                modules: [ Pagination, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
            ...
            if (document.querySelector(".top-list__slider")) new core(".top-list__slider", {
                ...
                speed: 800,
                navigation: {
                    nextEl: ".top-list__arrows_next",
                    prevEl: ".top-list__arrows_prev"
                },
                autoplay: {
                    delay: 2e3,
                    disableOnInteraction: true
